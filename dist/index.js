...
function initializeMermaid() {
  mermaid__default.default.initialize(MERMAID_CONFIG);
}
...
async function renderDiagram(chart) {
  try {
    ...
    const { svg } = await mermaid__default.default.render(DIAGRAM_ID, cleanedChart);
...
var MermaidVibes = ({
  ...
  const [imageMappings, setImageMappings] = react.useState(/* @__PURE__ */ new Map());
  react.useEffect(() => {
    initializeMermaid();
...
exports.MermaidVibes = MermaidVibes;
exports.PRIMARY = PRIMARY;
exports.TEXT = TEXT;
exports.exportAsJPG = exportAsJPG;
